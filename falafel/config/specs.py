...
static_specs = {
    ...
    "dumpe2fs-h"                : All([CommandSpec("/sbin/dumpe2fs -h {dumpdev}", dumpdev=r"\S+"),
                                   CommandSpec("/usr/sbin/dumpe2fs -h {dumpdev}", dumpdev=r"\S+")]),
    ...
    "ip_addr"                   : All([CommandSpec("/usr/sbin/ip addr"),
                                    CommandSpec("/sbin/ip addr")]),
    ...
    "lsblk"                     : All([CommandSpec("/bin/lsblk"), CommandSpec("/usr/bin/lsblk")]),
    ...
    "ls_boot"                   : All([CommandSpec("/usr/bin/ls -lanR /boot"),
                                    CommandSpec("/bin/ls -lanR /boot")]),
    "ls_dev"                    : All([CommandSpec("/usr/bin/ls -lanR /dev"),
                                    CommandSpec("/bin/ls -lanR /dev")]),
    "ls_etc"                    : All([CommandSpec("/usr/bin/ls -lan /etc"),
                                    CommandSpec("/bin/ls -lan /etc")]),
    "lsmod"                     : CommandSpec("/sbin/lsmod"),
    "lspci"                     : CommandSpec("/sbin/lspci"),
    "lvm.conf"                  : SimpleFileSpec("etc/lvm/lvm.conf"),
    "lvs"                       : All([CommandSpec("/usr/sbin/lvs -a -o lv_name,vg_name,lv_size,region_size,mirror_log,lv_attr,devices"),
                                   CommandSpec("/sbin/lvs -a -o lv_name,vg_name,lv_size,region_size,mirror_log,lv_attr,devices")]),
    ...
    "multipath_-v4_-ll"         : All([CommandSpec("/usr/sbin/multipath -v4 -ll"),
                                    CommandSpec("/sbin/multipath -v4 -ll")]),
    ...
    "pvs"                       : All([CommandSpec("/usr/sbin/pvs"),
                                    CommandSpec("/sbin/pvs")]),
    ...
    "vgdisplay"                 : All([CommandSpec("/usr/sbin/vgdisplay"),
