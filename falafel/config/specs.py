...
static_specs = {
    ...
    "foreman_proxy.log"         : First([SimpleFileSpec("var/log/foreman/pooxy.log", large_content=True),
                                    SimpleFileSpec("sos_commands/foreman/foreman-debug/var/log/foreman/proxy.log", large_content=True)]),
    ...
    "qpid_stat_q"               : First([CommandSpec("/usr/bin/qpid-stat -q --ssl-certificate=/etc/pki/katello/qpid_client_striped.crt -b amqps://localhost:5671"),
                                    SimpleFileSpec("qpid-stat-queues"),
                                    SimpleFileSpec("sos_commands/foreman/foreman-debug/qpid-stat-queues")]),
    "qpid_stat_u"               : First([CommandSpec("/usr/bin/qpid-stat -u --ssl-certificate=/etc/pki/katello/qpid_client_striped.crt -b amqps://localhost:5671"),
                                    SimpleFileSpec("qpid-stat-subscriptions"),
                                    SimpleFileSpec("sos_commands/foreman/foreman-debug/qpid-stat-subscriptions")]), 
