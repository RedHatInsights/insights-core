...
static_specs = {
    ...
    "lvs"                       : CommandSpec("/sbin/lvs --nameprefixes --noheadings --separator='|' -a -o lv_all"),
    ...
    "pvs"                       : CommandSpec("/sbin/pvs --nameprefixes --noheadings --separator='|' -a -o pv_all"),
    ...
    "vgs"                       : CommandSpec("/sbin/vgs --nameprefixes --noheadings --separator='|' -a -o vg_all"),
