...
from falafel.mappers.rhn_schema_stats import rhn_schema_stats
...
def test_rhn_schema_stats_pgs():
    ...
    pg_log = rhn_schema_stats(context_wrap(POSTGRESQL_LOG))
...
def test_rhn_schema_stats_ora():
    ora_log = rhn_schema_stats(context_wrap(ORACLE_LOG))
