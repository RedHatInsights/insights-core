...
from .. import Mapper, mapper, get_active_lines, defaults, LegacyItemAccess, AttributeDict
...
# TODO:
# Below 2 lines should be removed after insights-plugins used the new mappers
@mapper('grub2.cfg')
@mapper("grub.conf")
