...
IfCFG is a mapper for the network interface definition files in
...
Because this mapper reads multiple files, the interfaces are stored as a
list within the mapper and need to be iterated through in order to find
specific interfaces.
...
Examples:
    ...
    >>> for nic in shared[IfCFG]: # Mapper contains list of all interfaces
    ...     print 'NIC:', nic.iname
