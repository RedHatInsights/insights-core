...
This mapper reads the configuration of the GRand Unified Bootloader, version
1.
...
@mapper("grub.conf")
class Grub1Config(LegacyItemAccess, Mapper):
    """
        ...
        while (True):
            try:
                ...
                if line.startswith('menuentry '):
                    raise ParseException("Cannot process Grub v2 file in Grub1Config mapper. Please use Grub2Config mapper Original line = [%s]".format(line))
