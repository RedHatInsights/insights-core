from insights.mappers import vgdisplay
...
class TestVGdisplay():
    ...
    def test_VgDisplay(self):
        ...
        assert vg_info.data['debug_info'][0] == "Couldn't find device with uuid VVLmw8-e2AA-ECfW-wDPl-Vnaa-0wW1-utv7tV."
        assert vg_info.data['debug_info'][1] == "There are 1 physical volumes missing."
        assert vg_info.data['vginfo_dict'][0].get('Metadata Sequence No') == '5'
