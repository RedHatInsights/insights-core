from insights.mappers.heat_log import HeatApiLog
from insights.mappers.heat_log import HeatEngineLog
...
2016-11-09 14:32:44.169 4392 INFO heat.engine.environment [-] Registered: [Plugin](User:False) OS::Heat::AccessPolicy -> <class 'heat.engine.resources.openstack.heat.access_policy.AccessPolicy'>
"""
