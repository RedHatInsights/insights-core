from insights.mappers.pacemaker_log import PacemakerLog
...
Aug 21 12:58:32 [11661] example.redhat.com       crmd:     info: do_state_transition: 	State transition S_POLICY_ENGINE -> S_TRANSITION_ENGINE [ input=I_PE_SUCCESS
"""
