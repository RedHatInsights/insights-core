...
This mapper reads the ``/var/log`` directory listings and uses the FileListing
mapper class to provide a common access to them.
...
from .. import FileListing, mapper
...
class LsVarLog(FileListing):
    """
    A mapper for accessing "ls -laR /var/log".
    """
    ...
    def get_filepermissions(self, dir_name_where_to_search, dir_or_file_name_to_get):
        ...
        This is provided for several mappers which rely on this functionality,
