...
class InstalledRpm(object):
    ...
    def __eq__(self, other):
        ...
        return (rpm_vercmp.vercmp(self.epoch, other.epoch) == 0 and
                rpm_vercmp.vercmp(self.version, other.version) == 0 and
                rpm_vercmp.vercmp(self.release, other.release) == 0)
    ...
    def __lt__(self, other):
        ...
        ep = rpm_vercmp.vercmp(self.epoch, other.epoch)
        if ep != 0:
            return ep < 0
        vr = rpm_vercmp.vercmp(self.version, other.version)
        if vr != 0:
            return vr < 0
        return (rpm_vercmp.vercmp(self.release, other.release) < 0)
