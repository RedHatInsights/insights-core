...
from insights.specs import ceph_osd_df
from insights.specs import ceph_osd_dump
from insights.specs import ceph_osd_ec_profile_get
from insights.specs import ceph_osd_tree
...
class CephOsdDump(CephJsonParsing):
    ...
    >>> from insights.parsers.ceph_cmd_json_parsing import CephOsdDump
...
class CephOsdDf(CephJsonParsing):
    ...
    >>> from insights.parsers.ceph_cmd_json_parsing import CephOsdDf
    >>> from insights.tests import context_wrap
...
class CephDfDetail(CephJsonParsing):
    ...
    >>> from insights.tests import context_wrap
    >>> from insights.parsers.ceph_cmd_json_parsing import CephDfDetail
...
class CephHealthDetail(CephJsonParsing):
    ...
    >>> from insights.tests import context_wrap
    >>> from insights.parsers.ceph_cmd_json_parsing import CephHealthDetail
...
class CephECProfileGet(CephJsonParsing):
    ...
    >>> from insights.parsers.ceph_cmd_json_parsing import CephECProfileGet
    >>> from insights.tests import context_wrap
...
class CephCfgInfo(CephJsonParsing):
    ...
    >>> from insights.tests import context_wrap
    >>> from insights.parsers.ceph_cmd_json_parsing import CephCfgInfo
...
class CephOsdTree(CephJsonParsing):
    ...
    >>> from insights.tests import context_wrap
    >>> from insights.parsers.ceph_cmd_json_parsing import CephOsdTree
