...
Attributes:
    data (list): List of dictionaries, each containing one container record with the
        following fields:
...
class CrictlPs(CommandParser, list):
    ...
    This parser handles the complex structure of crictl output where fields may
    contain spaces and uses intelligent parsing to correctly separate container
    information.
