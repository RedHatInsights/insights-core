...
class AzureInstanceComputeMetadata(JSONParser):
    ...
    Examples:
        ...
        True
        >>> azure_instance_compute_metadata['vmId'] == '3c29e210-0669-496f-812a-2fffffffffff'
        True
        >>> azure_instance_compute_metadata['plan']['name'] == ''
        True
        >>> azure_instance_compute_metadata['plan']['product'] == 'planProduct'
        True
    """
