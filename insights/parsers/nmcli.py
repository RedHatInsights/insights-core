...
class NmcliDevShowSos(CommandParser, LegacyItemAccess):
    """
    .. warning::
        This parser is basic method, please use
        :py:class:`insights.combiners.nmcli.Allnmclidevshow` instead.
    ...
    Examples:
        >>> type(nmcli_obj_sos)
        <class 'insights.parsers.nmcli.NmcliDevShowSos'>
        >>> nmcli_obj_sos.data['em3']['STATE']
        'connected'
        >>> sorted(nmcli_obj_sos.connected_devices)
        ['em3']
