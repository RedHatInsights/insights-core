...
class JbossRuntimeVersions(Parser):
    """
     Versions of multiple running JBoss - File ``data/insights_commands/jboss_versions``
     ===================================================================================
     ...
     Examples:
         >>> len(all_jboss_versions.versions)
         1
         >>> all_jboss_versions.versions[0].major
         7
         >>> all_jboss_versions.versions[0].minor
         3
         >>> all_jboss_versions.versions[0].release
         0
     """
    ...
    def parse_content(self, content):
        ...
        for j_path, version_content in jboss_version_dict.items():
            self.versions.append(JbossVersion(context_wrap(version_content, path=j_path)))
