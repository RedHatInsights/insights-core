...
def test_libkeyutils():
    libkeyutils_search = Libkeyutils(context_wrap(SEARCH))
    assert libkeyutils_search.data == SEARCH.split('\n')

    libkeyutils_search = LibkeyutilsObjdumps(context_wrap(DUMPS))
    assert libkeyutils_search.data == DUMPS.split('\n')
