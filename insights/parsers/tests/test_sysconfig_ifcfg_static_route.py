...
def test_static_route_connection_1():
    ...
    assert r.data == {'route-test-net': ['ADDRESS0=10.65.223.0', 'NETMASK0=255.255.254.0', 'GATEWAY0=10.65.223.1']}


def test_static_route_connection_2():
    context = context_wrap(STATIC_ROUTE_1, CONTEXT_PATH_DEVICE_2)
    r = IfCFGStaticRoute(context)
    assert r.data == {'route-test-net-11': ['ADDRESS0=10.65.223.0', 'NETMASK0=255.255.254.0', 'GATEWAY0=10.65.223.1']}
...
def test_missing_index():
    with pytest.raises(AssertionError):
        ...
        r = IfCFGStaticRoute(context)
        assert r.data == {'ifcfg-eth0': ['ADDRESS0=10.65.223.0', 'NETMASK0=255.255.254.0', 'GATEWAY0=10.65.223.1']}
