...
def test_static_route_connection_1():
    ...
    assert r.data == {'test-net': ['ADDRESS0=10.65.223.0', 'NETMASK0=255.255.254.0', 'GATEWAY0=10.65.223.1']}
...
def test_static_route_connection_2():
    ...
    assert r.data == {'test-net-11': ['ADDRESS0=10.65.223.0', 'NETMASK0=255.255.254.0', 'GATEWAY0=10.65.223.1']}
...
def test_missing_index():
    with pytest.raises(IndexError):
        ...
        r = IfCFGStaticRoute(context)
        assert r.data == {'eth0': ['ADDRESS0=10.65.223.0', 'NETMASK0=255.255.254.0', 'GATEWAY0=10.65.223.1']}
