...
def test_ls_origin_local_volumes_pods():
    ...
    assert len(ls_origin_local_volumes_pods.dirs_of("/var/lib/origin/openshift/local/volumes/pods")) == 5
    assert ls_origin_local_volumes_pods.dirs_of("/var/lib/origin/openshift/local/volumes/pods") == [
