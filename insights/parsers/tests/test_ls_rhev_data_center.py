import doctest
from insights.parsers import ls_rhev_data_center as ls_dc
...
def test_ls_rhev_data_center():
    ls_rhev_dc = ls_dc.LsRhevDataCenter(context_wrap(LS_RHEV_DATA_CENTER))
    assert ls_rhev_dc.dir_entry('/rhev/data-center/mnt/host1.example.com:_nfsshare_data/a384bf5d-db92-421e-926d-bfb99a6b4b28/images/b7d6cc07-d1f1-44b3-b3c0-7067ec7056a3', '4d6e5dea-995f-4a4e-b487-0f70361f6137')['owner'] == 'root'
    assert ls_rhev_dc.dir_entry('/rhev/data-center/mnt/host1.example.com:_nfsshare_data/a384bf5d-db92-421e-926d-bfb99a6b4b28/images/b7d6cc07-d1f1-44b3-b3c0-7067ec7056a3', '4d6e5dea-995f-4a4e-b487-0f70361f6137')['group'] == 'root'


def test_ls_rhev_data_center_doc_examples():
    failed, total = doctest.testmod(
        ls_dc,
        globs={'ls_rhev_dc': ls_dc.LsRhevDataCenter(context_wrap(LS_RHEV_DATA_CENTER))}
    )
    assert failed == 0
