...
from insights.mappers.hostname import Hostname as hname
from insights.mappers.facter import Facter as facter
from insights.mappers.systemid import SystemID as systemid
...
def hostname(local, shared):
    ...
    Returns:
        insights.reducers.hostname.Hostname: A named tuple with `fqdn`,
