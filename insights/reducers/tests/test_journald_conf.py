...
from insights.reducers.journald_conf import JournaldConfAll
...
def test_1():
    ...
    result = JournaldConfAll(None, shared)
...
def test_11():
    # Even if the path is None (in case Mapper somehow fails to get it), make sure priorities work.
