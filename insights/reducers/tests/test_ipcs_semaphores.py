from insights.mappers.ipcs_sem import IpcsSI, IpcsS
from insights.mappers.ps import PsAuxcww
from insights.reducers.ipcs_semaphores import IpcsSemaphores
