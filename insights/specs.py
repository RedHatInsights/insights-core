...
candlepin_error_log = sf.simple_file(r"sos_commands/foreman/foreman-debug/var/log/candlepin/error.log", name="candlepin_error_log", context=HostArchiveContext)
