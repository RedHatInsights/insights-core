...
chronyc_sources = sf.simple_command("/usr/bin/chronyc sources")
...
uploader_log = sf.simple_file("/var/log/redhat-access-insights/redhat-access-insights.log", name="uploader_log", alias="uploader.log")
