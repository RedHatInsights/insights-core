...
httpd_conf = sf.glob_file(["/etc/httpd/conf/httpd.conf",
                           "/etc/httpd/conf.d/*.conf"],
                           name="httpd_conf"),
httpd_conf_sos = sf.glob_file(["/conf/httpd/conf/httpd.conf",
                               "/conf/httpd/conf.d/*.conf"],
                               name="httpd_conf_sos")
...
limits_conf = sf.glob_file(["/etc/security/limits.conf",
