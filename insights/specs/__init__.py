...
class Specs(SpecSet):
    ...
    ansible_host = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    blacklist_report = RegistryPoint(prio=-1)
    blacklisted_specs = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'], prio=-1)
    branch_info = RegistryPoint()  # https://issues.redhat.com/browse/RHIN-639
    display_name = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    egg_release = RegistryPoint()
    tags = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    version_info = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ...
    abrt_ccpp_conf = RegistryPoint(filterable=True, no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ...
    azure_instance_id = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    azure_instance_plan = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    azure_instance_type = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    azure_load_balancer = RegistryPoint()
    basic_auth_insights_client = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    bdi_read_ahead_kb = RegistryPoint(
        multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6', 'mac']
    )
    bios_uuid = RegistryPoint()
    blkid = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ...
    cciss = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ...
    certificates_enddate = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    cgroups = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    checkin_conf = RegistryPoint()
    chkconfig = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ...
    cloud_init_query = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ...
    cpe = RegistryPoint()
    cpu_cores = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    cpu_siblings = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    cpu_smt_active = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    cpu_smt_control = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    cpu_vulns = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    cpuinfo = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    cpupower_frequency_info = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    cpuset_cpus = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ...
    crt = RegistryPoint()
    crypto_policies_bind = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    crypto_policies_config = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    crypto_policies_opensshserver = RegistryPoint()
    crypto_policies_state_current = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ...
    cups_ppd = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    current_clocksource = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    date = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    date_utc = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ...
    db2ls_a_c = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ...
    df__li = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    dig = RegistryPoint()
    ...
    dnf_modules = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ...
    dotnet_version = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    doveconf = RegistryPoint(filterable=True)
    dracut_kdump_capture_service = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    dse_ldif = RegistryPoint(multi_output=True, filterable=True)
    du_dirs = RegistryPoint(
        multi_output=True, filterable=True, no_obfuscate=['hostname', 'ip', 'ipv6', 'mac']
    )
    ...
    etc_machine_id = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ...
    ethtool = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ethtool_S = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ethtool_T = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ethtool_a = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ethtool_c = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ethtool_g = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ethtool_i = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ethtool_k = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    facter = RegistryPoint()
    falconctl_aid = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    falconctl_backend = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    falconctl_rfm = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    falconctl_version = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    fapolicyd_rules = RegistryPoint(
        multi_output=True, filterable=True, no_obfuscate=['hostname', 'ip', 'ipv6', 'mac']
    )
    fc_match = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    fcoeadm_i = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    filefrag = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    files_dirs_number_filter = RegistryPoint(filterable=True)
    files_dirs_number = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    findmnt_lo_propagation = RegistryPoint()
    firewall_cmd_list_all_zones = RegistryPoint()
    firewalld_conf = RegistryPoint(filterable=True, no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    flatpak_list = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ...
    foreman_rake_db_migrate_status = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ...
    gcp_instance_type = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    gcp_license_codes = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    gcp_network_interfaces = RegistryPoint()
    getcert_list = RegistryPoint()
    getconf_page_size = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    getenforce = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    getsebool = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ...
    group_info = RegistryPoint(filterable=True, no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    grub1_config_perms = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    grub2_cfg = RegistryPoint()
    grub2_efi_cfg = RegistryPoint()
    grub_conf = RegistryPoint()
    grub_config_perms = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    grub_efi_conf = RegistryPoint()
    grubby_default_index = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    grubby_default_kernel = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    grubby_info_all = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ...
    heat_crontab = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    heat_engine_log = RegistryPoint(filterable=True)
    hostname = RegistryPoint(no_obfuscate=['ip', 'ipv6', 'mac'])
    hostname_default = RegistryPoint(no_obfuscate=['ip', 'ipv6', 'mac'])
    hostname_short = RegistryPoint(no_obfuscate=['ip', 'ipv6', 'mac'])
    hosts = RegistryPoint()
    hponcfg_g = RegistryPoint()
    httpd24_httpd_error_log = RegistryPoint(filterable=True)
    httpd_M = RegistryPoint(multi_output=True)
    httpd_V = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ...
    httpd_limits = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    httpd_on_nfs = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    httpd_ssl_access_log = RegistryPoint(filterable=True)
    httpd_ssl_cert_enddate = RegistryPoint(multi_output=True, no_obfuscate=['ip', 'ipv6', 'mac'])
    httpd_ssl_error_log = RegistryPoint(filterable=True)
    ibm_fw_vernum_encoded = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ...
    init_process_cgroup = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    initctl_lst = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    initscript = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    insights_client_conf = RegistryPoint(filterable=True)
    installed_rpms = RegistryPoint(no_obfuscate=['ip', 'ipv6', 'mac'])
    interrupts = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ...
    ipcs_m = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ipcs_m_p = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ipcs_s = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ipcs_s_i = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ...
    iris_list = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ...
    jboss_runtime_versions = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ...
    jboss_version = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    journal_all = RegistryPoint(filterable=True)
    journal_header = RegistryPoint(filterable=True, no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ...
    kexec_crash_loaded = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    kexec_crash_size = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    keystone_conf = RegistryPoint()
    keystone_crontab = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    keystone_log = RegistryPoint(filterable=True)
    kpatch_list = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    krb5 = RegistryPoint(multi_output=True)
    ksmstate = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ktimer_lockless = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    kubelet_conf = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    kubepods_cpu_quota = RegistryPoint(
        multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6', 'mac']
    )
    lastupload = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ld_library_path_global_conf = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    leapp_migration_results = RegistryPoint()
    leapp_report = RegistryPoint()
    ld_library_path_of_user = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ...
    limits_conf = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    locale = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    localectl_status = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    localtime = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    login_pam_conf = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    logrotate_conf = RegistryPoint(multi_output=True)
    losetup = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    lpfc_max_luns = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    lpstat_p = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ...
    lscpu = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    lsinitrd = RegistryPoint(filterable=True, no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ...
    lsmod = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    lsof = RegistryPoint(filterable=True)
    lspci = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    lspci_vmmkn = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    lssap = RegistryPoint()
    lsscsi = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    luksmeta = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    lvdisplay = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    lvm_conf = RegistryPoint(filterable=True, no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    lvm_fullreport = RegistryPoint()
    lvm_system_devices = RegistryPoint(no_obfuscate=['ip', 'ipv6', 'mac'])
    lvmconfig = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ...
    manila_conf = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    mariadb_log = RegistryPoint(filterable=True)
    max_uid = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    md5chk_files = RegistryPoint(multi_output=True)
    mdadm_D = RegistryPoint()
    mdadm_E = RegistryPoint(multi_output=True)
    mdstat = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    meminfo = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ...
    mlx4_port = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    modinfo_filtered_modules = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    modinfo_modules = RegistryPoint(filterable=True, no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    modprobe = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    mokutil_sbstate = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    mongod_conf = RegistryPoint(multi_output=True, filterable=True)
    mount = RegistryPoint()
    mountinfo = RegistryPoint()
    mounts = RegistryPoint()
    mpirun_version = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    mssql_api_assessment = RegistryPoint()
    mssql_conf = RegistryPoint()
    mssql_tls_cert_enddate = RegistryPoint()
    multicast_querier = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ...
    nmcli_conn_show = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ...
    nova_uid = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ...
    numa_cpus = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    numeric_user_group_name = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    nvidia_smi_active_clocks_event_reasons = RegistryPoint(
        no_obfuscate=['hostname', 'ip', 'ipv6', 'mac']
    )
    nvidia_smi_l = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    nvidia_smi_query_gpu = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    nvme_core_io_timeout = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ...
    od_cpu_dma_latency = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ...
    os_release = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ...
    parted__l = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ...
    pmlog_summary_pcp_zeroconf = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ...
    proc_keys = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    proc_keyusers = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    proc_netstat = RegistryPoint()
    proc_slabinfo = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    proc_snmp_ipv4 = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    proc_snmp_ipv6 = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    proc_stat = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ...
    puppet_ca_cert_expire_date = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ...
    ql2xmaxlun = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ql2xmqsupport = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ...
    readlink_e_etc_mtab = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    readlink_e_shift_cert_client = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    readlink_e_shift_cert_server = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    rear_local_conf = RegistryPoint(filterable=True)
    recvq_socket_buffer = RegistryPoint()
    redhat_release = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    repquota_agnpuv = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ...
    rhsm_releasever = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    rhui_releasever = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    rhui_set_release = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ...
    route = RegistryPoint()
    rpm_V_package = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    rpm_V_package_list = RegistryPoint(filterable=True)
    rpm_ostree_status = RegistryPoint()
    rpm_pkgs = RegistryPoint(no_obfuscate=['ip', 'ipv6', 'mac'])
    rsyslog_conf = RegistryPoint(filterable=True, multi_output=True)
    rsyslog_tls_ca_cert_enddate = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    rsyslog_tls_cert_enddate = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ...
    saphostexec_status = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    saphostexec_version = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    sat5_insights_properties = RegistryPoint()
    satellite_compute_resources = RegistryPoint()
    satellite_content_hosts_count = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ...
    satellite_host_facts_count = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    satellite_katello_repos_with_muliple_ref = RegistryPoint()
    satellite_logs_table_size = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ...
    satellite_revoked_cert_count = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    satellite_rhv_hosts_count = RegistryPoint()
    satellite_sca_status = RegistryPoint()
    satellite_settings = RegistryPoint()
    satellite_version_rb = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ...
    scsi_mod_max_report_luns = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    scsi_mod_use_blk_mq = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    sctp_asc = RegistryPoint()
    sctp_eps = RegistryPoint()
    sctp_snmp = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    sealert = RegistryPoint()
    secure = RegistryPoint(filterable=True)
    securetty = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    selinux_config = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    selinux_users = RegistryPoint(filterable=True, no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    sendmail_mc = RegistryPoint(filterable=True, no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    sendq_socket_buffer = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    sestatus = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ...
    sshd_config_perms = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ...
    subscription_manager_id = RegistryPoint(no_obfuscate=['ip', 'ipv6', 'mac'])
    ...
    sys_kernel_sched_features = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ...
    systemctl_get_default = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    systemctl_list_unit_files = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    systemctl_list_units = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ...
    thp_enabled = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ...
    uname = RegistryPoint(no_obfuscate=['ip', 'ipv6', 'mac'])
    up2date = RegistryPoint(filterable=True)
    up2date_log = RegistryPoint(filterable=True)
    uptime = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ...
    vdsm_id = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ...
    virt_what = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    virt_who_conf = RegistryPoint(multi_output=True, filterable=True)
    virtlogd_conf = RegistryPoint(filterable=True)
    vma_ra_enabled = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    ...
    x86_ibpb_enabled = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    x86_ibrs_enabled = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    x86_pti_enabled = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    x86_retp_enabled = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    xfs_info = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    xfs_quota_state = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
    xinetd_conf = RegistryPoint(multi_output=True)
    yum_conf = RegistryPoint(filterable=True)
    yum_list_available = RegistryPoint(no_obfuscate=['ip', 'ipv6', 'mac'])
    yum_list_installed = RegistryPoint(no_obfuscate=['ip', 'ipv6', 'mac'])
    yum_log = RegistryPoint(filterable=True, no_obfuscate=['ip', 'ipv6', 'mac'])
    yum_repolist = RegistryPoint()
    yum_repos_d = RegistryPoint(multi_output=True)
    yum_updateinfo = RegistryPoint(no_obfuscate=['ip', 'ipv6', 'mac'])
    yum_updates = RegistryPoint(no_obfuscate=['ip', 'ipv6', 'mac'])
    ...
    container_installed_rpms = RegistryPoint(multi_output=True, no_obfuscate=['ip', 'ipv6', 'mac'])
    ...
    containers_inspect = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'mac'])
