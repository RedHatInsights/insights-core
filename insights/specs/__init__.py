...
class Specs(SpecSet):
    ...
    ansible_host = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    blacklist_report = RegistryPoint(prio=-1)
    blacklisted_specs = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'], prio=-1)
    branch_info = RegistryPoint()  # https://issues.redhat.com/browse/RHIN-639
    display_name = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    egg_release = RegistryPoint()
    tags = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    version_info = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    ...
    abrt_ccpp_conf = RegistryPoint(filterable=True, no_obfuscate=['hostname', 'ip', 'ipv6'])
    abrt_status_bare = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    alternatives_display_python = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    amq_broker = RegistryPoint(multi_output=True)
    audit_log = RegistryPoint(filterable=True)
    auditctl_rules = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    auditctl_status = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    ...
    azure_instance_id = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    azure_instance_plan = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    azure_instance_type = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    azure_load_balancer = RegistryPoint()
    basic_auth_insights_client = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    bdi_read_ahead_kb = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6'])
    bios_uuid = RegistryPoint()
    blkid = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    bond = RegistryPoint(multi_output=True)
    bond_dynamic_lb = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6'])
    ...
    cciss = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6'])
    ...
    certificates_enddate = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    cgroups = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    checkin_conf = RegistryPoint()
    chkconfig = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    ...
    cloud_init_query = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    ...
    cpe = RegistryPoint()
    cpu_cores = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6'])
    cpu_siblings = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6'])
    cpu_smt_active = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    cpu_smt_control = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    cpu_vulns = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6'])
    cpuinfo = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    cpupower_frequency_info = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    cpuset_cpus = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    ...
    crt = RegistryPoint()
    crypto_policies_bind = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    crypto_policies_config = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    crypto_policies_opensshserver = RegistryPoint()
    crypto_policies_state_current = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    cryptsetup_luksDump = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6'])
    cupsd_conf = RegistryPoint()
    cups_browsed_conf = RegistryPoint(filterable=True)
    cups_files_conf = RegistryPoint()
    cups_ppd = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6'])
    current_clocksource = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    date = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    date_utc = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    db2_database_configuration = RegistryPoint(
        multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6']
    )
    db2_database_manager = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6'])
    db2ls_a_c = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    ...
    df__li = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    dig = RegistryPoint()
    ...
    dnf_modules = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6'])
    ...
    dotnet_version = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    doveconf = RegistryPoint(filterable=True)
    dracut_kdump_capture_service = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    dse_ldif = RegistryPoint(multi_output=True, filterable=True)
    du_dirs = RegistryPoint(
        multi_output=True, filterable=True, no_obfuscate=['hostname', 'ip', 'ipv6']
    )
    ...
    etc_machine_id = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    ...
    ethtool = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6'])
    ethtool_S = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6'])
    ethtool_T = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6'])
    ethtool_a = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6'])
    ethtool_c = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6'])
    ethtool_g = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6'])
    ethtool_i = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6'])
    ethtool_k = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6'])
    facter = RegistryPoint()
    falconctl_aid = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    falconctl_backend = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    falconctl_rfm = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    falconctl_version = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    fapolicyd_rules = RegistryPoint(
        multi_output=True, filterable=True, no_obfuscate=['hostname', 'ip', 'ipv6']
    )
    fc_match = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    fcoeadm_i = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    filefrag = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    files_dirs_number_filter = RegistryPoint(filterable=True)
    files_dirs_number = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    findmnt_lo_propagation = RegistryPoint()
    firewall_cmd_list_all_zones = RegistryPoint()
    firewalld_conf = RegistryPoint(filterable=True, no_obfuscate=['hostname', 'ip', 'ipv6'])
    flatpak_list = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    ...
    foreman_rake_db_migrate_status = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    ...
    gcp_instance_type = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    gcp_license_codes = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    gcp_network_interfaces = RegistryPoint()
    getcert_list = RegistryPoint()
    getconf_page_size = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    getenforce = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    getsebool = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    ...
    group_info = RegistryPoint(filterable=True, no_obfuscate=['hostname', 'ip', 'ipv6'])
    grub1_config_perms = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    grub2_cfg = RegistryPoint()
    grub2_efi_cfg = RegistryPoint()
    grub_conf = RegistryPoint()
    grub_config_perms = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    grub_efi_conf = RegistryPoint()
    grubby_default_index = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    grubby_default_kernel = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    grubby_info_all = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    ...
    heat_crontab = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    heat_engine_log = RegistryPoint(filterable=True)
    hostname = RegistryPoint(no_obfuscate=['ip', 'ipv6'])
    hostname_default = RegistryPoint(no_obfuscate=['ip', 'ipv6'])
    hostname_short = RegistryPoint(no_obfuscate=['ip', 'ipv6'])
    hosts = RegistryPoint()
    hponcfg_g = RegistryPoint()
    httpd24_httpd_error_log = RegistryPoint(filterable=True)
    httpd_M = RegistryPoint(multi_output=True)
    httpd_V = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6'])
    httpd_access_log = RegistryPoint(filterable=True)
    httpd_cert_info_in_nss = RegistryPoint(
        multi_output=True, filterable=True, no_obfuscate=['ip', 'ipv6']
    )
    ...
    httpd_limits = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6'])
    httpd_on_nfs = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    httpd_ssl_access_log = RegistryPoint(filterable=True)
    httpd_ssl_cert_enddate = RegistryPoint(multi_output=True, no_obfuscate=['ip', 'ipv6'])
    httpd_ssl_error_log = RegistryPoint(filterable=True)
    ibm_fw_vernum_encoded = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    ibm_lparcfg = RegistryPoint(filterable=True, no_obfuscate=['hostname', 'ip', 'ipv6'])
    ifcfg = RegistryPoint(multi_output=True)
    ifcfg_static_route = RegistryPoint(filterable=True, multi_output=True)
    ilab_model_list = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    imagemagick_policy = RegistryPoint(
        multi_output=True, filterable=True, no_obfuscate=['ip', 'ipv6']
    )
    image_builder_facts = RegistryPoint()
    init_ora = RegistryPoint()
    init_process_cgroup = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    initctl_lst = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    initscript = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6'])
    insights_client_conf = RegistryPoint(filterable=True)
    installed_rpms = RegistryPoint(no_obfuscate=['ip', 'ipv6'])
    interrupts = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    ...
    ipcs_m = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    ipcs_m_p = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    ipcs_s = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    ipcs_s_i = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6'])
    ...
    iris_list = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    ...
    jboss_runtime_versions = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    ...
    jboss_version = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6'])
    journal_all = RegistryPoint(filterable=True)
    journal_header = RegistryPoint(filterable=True, no_obfuscate=['hostname', 'ip', 'ipv6'])
    journal_since_boot = RegistryPoint(filterable=True)
    katello_service_status = RegistryPoint(filterable=True, no_obfuscate=['hostname', 'ip', 'ipv6'])
    kdump_conf = RegistryPoint()
    kerberos_kdc_log = RegistryPoint(filterable=True)
    kernel_config = RegistryPoint(
        multi_output=True, filterable=True, no_obfuscate=['hostname', 'ip', 'ipv6']
    )
    kernel_crash_kexec_post_notifiers = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    kexec_crash_loaded = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    kexec_crash_size = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    keystone_conf = RegistryPoint()
    keystone_crontab = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    keystone_log = RegistryPoint(filterable=True)
    kpatch_list = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    krb5 = RegistryPoint(multi_output=True)
    ksmstate = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    ktimer_lockless = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    kubelet_conf = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    kubepods_cpu_quota = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6'])
    lastupload = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6'])
    ld_library_path_global_conf = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    leapp_migration_results = RegistryPoint()
    leapp_report = RegistryPoint()
    ld_library_path_of_user = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    ...
    limits_conf = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6'])
    locale = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    localectl_status = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    localtime = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    login_pam_conf = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    logrotate_conf = RegistryPoint(multi_output=True)
    losetup = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    lpfc_max_luns = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    lpstat_p = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    ...
    # ^ End of ls
    lsattr = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    lsattr_files_or_dirs = RegistryPoint(filterable=True)
    lsblk = RegistryPoint()
    lsblk_pairs = RegistryPoint()
    lscpu = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    lsinitrd = RegistryPoint(filterable=True, no_obfuscate=['hostname', 'ip', 'ipv6'])
    lsinitrd_kdump_image = RegistryPoint(filterable=True, no_obfuscate=['hostname', 'ip', 'ipv6'])
    lsinitrd_lvm_conf = RegistryPoint(filterable=True, no_obfuscate=['hostname', 'ip', 'ipv6'])
    lsmod = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    lsof = RegistryPoint(filterable=True)
    lspci = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    lspci_vmmkn = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    lssap = RegistryPoint()
    lsscsi = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    luksmeta = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6'])
    lvdisplay = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    lvm_conf = RegistryPoint(filterable=True, no_obfuscate=['hostname', 'ip', 'ipv6'])
    lvm_fullreport = RegistryPoint()
    lvm_system_devices = RegistryPoint(no_obfuscate=['ip', 'ipv6'])
    lvmconfig = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    lvs_headings = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    lvs_noheadings = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    lvs_noheadings_all = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    mac_addresses = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6'])
    machine_id = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6', 'password'], no_redact=True)
    manila_conf = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    mariadb_log = RegistryPoint(filterable=True)
    max_uid = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    md5chk_files = RegistryPoint(multi_output=True)
    mdadm_D = RegistryPoint()
    mdadm_E = RegistryPoint(multi_output=True)
    mdstat = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    meminfo = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    ...
    mlx4_port = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6'])
    modinfo_filtered_modules = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    modinfo_modules = RegistryPoint(filterable=True, no_obfuscate=['hostname', 'ip', 'ipv6'])
    modprobe = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6'])
    mokutil_sbstate = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    mongod_conf = RegistryPoint(multi_output=True, filterable=True)
    mount = RegistryPoint()
    mountinfo = RegistryPoint()
    mounts = RegistryPoint()
    mpirun_version = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    mssql_api_assessment = RegistryPoint()
    mssql_conf = RegistryPoint()
    mssql_tls_cert_enddate = RegistryPoint()
    multicast_querier = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    ...
    nmcli_conn_show = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    ...
    nova_uid = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    ...
    numa_cpus = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6'])
    numeric_user_group_name = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    nvidia_smi_active_clocks_event_reasons = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    nvidia_smi_l = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    nvidia_smi_query_gpu = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    nvme_core_io_timeout = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    ...
    od_cpu_dma_latency = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    ...
    os_release = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    ...
    package_provides_command = RegistryPoint(
        filterable=True, no_obfuscate=['hostname', 'ip', 'ipv6']
    )
    pam_conf = RegistryPoint()
    parted__l = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    ...
    pmlog_summary = RegistryPoint(
        no_obfuscate=['hostname', 'ip', 'ipv6']
    )  # TODO: Remove after 'pcp_raw_data' works
    pmlog_summary_pcp_zeroconf = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    ...
    proc_keys = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    proc_keyusers = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    proc_netstat = RegistryPoint()
    proc_slabinfo = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    proc_snmp_ipv4 = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    proc_snmp_ipv6 = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    proc_stat = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    ...
    puppet_ca_cert_expire_date = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    ...
    ql2xmaxlun = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    ql2xmqsupport = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    ...
    readlink_e_etc_mtab = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    readlink_e_shift_cert_client = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    readlink_e_shift_cert_server = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    rear_local_conf = RegistryPoint(filterable=True)
    recvq_socket_buffer = RegistryPoint()
    redhat_release = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    repquota_agnpuv = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    ...
    rhsm_releasever = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    rhui_releasever = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    rhui_set_release = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    ...
    route = RegistryPoint()
    rpm_V_package = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6'])
    rpm_V_package_list = RegistryPoint(filterable=True)
    rpm_ostree_status = RegistryPoint()
    rpm_pkgs = RegistryPoint(no_obfuscate=['ip', 'ipv6'])
    rsyslog_conf = RegistryPoint(filterable=True, multi_output=True)
    rsyslog_tls_ca_cert_enddate = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    rsyslog_tls_cert_enddate = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    ...
    sap_hdb_version = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6'])
    ...
    saphostexec_status = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    saphostexec_version = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    sat5_insights_properties = RegistryPoint()
    satellite_compute_resources = RegistryPoint()
    satellite_content_hosts_count = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    ...
    satellite_host_facts_count = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    satellite_katello_repos_with_muliple_ref = RegistryPoint()
    satellite_logs_table_size = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    ...
    satellite_qualified_katello_repos = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    satellite_revoked_cert_count = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    satellite_rhv_hosts_count = RegistryPoint()
    satellite_sca_status = RegistryPoint()
    satellite_settings = RegistryPoint()
    satellite_version_rb = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    ...
    scsi_mod_max_report_luns = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    scsi_mod_use_blk_mq = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    sctp_asc = RegistryPoint()
    sctp_eps = RegistryPoint()
    sctp_snmp = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    sealert = RegistryPoint()
    secure = RegistryPoint(filterable=True)
    securetty = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    selinux_config = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    selinux_users = RegistryPoint(filterable=True, no_obfuscate=['hostname', 'ip', 'ipv6'])
    sendmail_mc = RegistryPoint(filterable=True, no_obfuscate=['hostname', 'ip', 'ipv6'])
    sendq_socket_buffer = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    sestatus = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    setup_named_chroot = RegistryPoint(filterable=True, no_obfuscate=['hostname', 'ip', 'ipv6'])
    smartctl = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6'])
    smartpdc_settings = RegistryPoint(filterable=True)
    smbstatus_S = RegistryPoint()
    smbstatus_p = RegistryPoint()
    sockstat = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    softnet_stat = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    software_collections_list = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    ...
    sshd_config_perms = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    ...
    subscription_manager_id = RegistryPoint(no_obfuscate=['ip', 'ipv6'])
    subscription_manager_installed_product_ids = RegistryPoint(
        filterable=True, no_obfuscate=['hostname', 'ip', 'ipv6']
    )
    subscription_manager_list_consumed = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    subscription_manager_list_installed = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    subscription_manager_release_show = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    subscription_manager_status = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    ...
    sys_fs_cgroup_memory_tasks_number = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    sys_fs_cgroup_uniq_memory_swappiness = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    sys_kernel_sched_features = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    sys_vmbus_class_id = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6'])
    sys_vmbus_device_id = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6'])
    ...
    systemctl_get_default = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    systemctl_list_unit_files = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    systemctl_list_units = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    ...
    thp_enabled = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    ...
    tty_console_active = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    ...
    uname = RegistryPoint(no_obfuscate=['ip', 'ipv6'])
    up2date = RegistryPoint(filterable=True)
    up2date_log = RegistryPoint(filterable=True)
    uptime = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    ...
    vdsm_id = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    ...
    vhost_net_zero_copy_tx = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    virsh_list_all = RegistryPoint()
    virt_uuid_facts = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    virt_what = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    virt_who_conf = RegistryPoint(multi_output=True, filterable=True)
    virtlogd_conf = RegistryPoint(filterable=True)
    vma_ra_enabled = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    ...
    x86_ibpb_enabled = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    x86_ibrs_enabled = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    x86_pti_enabled = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    x86_retp_enabled = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    xfs_info = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6'])
    xfs_quota_state = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
    xinetd_conf = RegistryPoint(multi_output=True)
    yum_conf = RegistryPoint(filterable=True)
    yum_list_available = RegistryPoint(no_obfuscate=['ip', 'ipv6'])
    yum_list_installed = RegistryPoint(no_obfuscate=['ip', 'ipv6'])
    yum_log = RegistryPoint(filterable=True, no_obfuscate=['ip', 'ipv6'])
    yum_repolist = RegistryPoint()
    yum_repos_d = RegistryPoint(multi_output=True)
    yum_updateinfo = RegistryPoint(no_obfuscate=['ip', 'ipv6'])
    yum_updates = RegistryPoint(no_obfuscate=['ip', 'ipv6'])
    zdump_v = RegistryPoint()
    zipl_conf = RegistryPoint()

    # container_specs
    container_cpu_online = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip', 'ipv6'])
    ...
    container_installed_rpms = RegistryPoint(multi_output=True, no_obfuscate=['ip', 'ipv6'])
    container_inspect_keys = RegistryPoint(filterable=True, no_obfuscate=['hostname', 'ip', 'ipv6'])
    ...
    containers_inspect = RegistryPoint(no_obfuscate=['hostname', 'ip', 'ipv6'])
