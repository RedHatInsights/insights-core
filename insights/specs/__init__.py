...
class Specs(SpecSet):
    ...
    cpuinfo_max_freq = RegistryPoint(no_obfuscate=['hostname', 'ip'])
    ...
    date_iso = RegistryPoint(no_obfuscate=['hostname', 'ip'])
    ...
    fdisk_l = RegistryPoint(no_obfuscate=['hostname', 'ip'])
    fdisk_l_sos = RegistryPoint(multi_output=True, no_obfuscate=['hostname', 'ip'])
    ...
    heat_crontab_container = RegistryPoint(no_obfuscate=['hostname', 'ip'])
    ...
    keystone_crontab_container = RegistryPoint(no_obfuscate=['hostname', 'ip'])
