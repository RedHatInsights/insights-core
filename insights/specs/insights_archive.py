...
class InsightsArchiveSpecs(Specs):
    ...
    teamdctl_config_dump = glob_file("insights_commands/usr/bin/teamdctl_*_config_dump")
    teamdctl_state_dump = glob_file("insights_commands/usr/bin/teamdctl_*_state_dump")
