...
class InsightsArchiveSpecs(Specs):
    ...
    grub1_config_perms = first_file([simple_file("insights_commands/ls_-lH_.boot.grub.grub.conf"), simple_file("insights_commands/ls_-l_.boot.grub.grub.conf")])
    grub_config_perms = first_file([simple_file("insights_commands/ls_-lH_.boot.grub2.grub.cfg"), simple_file("insights_commands/ls_-l_.boot.grub2.grub.cfg")])
    ...
    sshd_config_perms = first_file([simple_file("insights_commands/ls_-lH_.etc.ssh.sshd_config"), simple_file("insights_commands/ls_-l_.etc.ssh.sshd_config")])
