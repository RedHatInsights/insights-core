...
class InsightsArchiveSpecs(Specs):
    ...
    satellite_logs_table_size = simple_file("insights_commands/sudo_-iu_postgres_.usr.bin.psql_-d_foreman_-c_select_pg_size_pretty_pg_total_relation_size_logs_as_logs_size_--csv")
