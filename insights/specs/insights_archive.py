...
class InsightsArchiveSpecs(Specs):
    ...
    gcp_instance_type = simple_file(
        "insights_commands/python_-m_insights.tools.cat_--no-header_gcp_instance_type"
    )
    gcp_license_codes = simple_file(
        "insights_commands/python_-m_insights.tools.cat_--no-header_gcp_license_codes"
    )
