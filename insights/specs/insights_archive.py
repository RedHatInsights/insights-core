...
class InsightsArchiveSpecs(Specs):
    ...
    satellite_capsule_with_background_downloadpolicy = simple_file("insights_commands/sudo_-iu_postgres_.usr.bin.psql_-d_foreman_-c_select_name_from_smart_proxies_where_download_policy_background_--csv")
    ...
    satellite_repos_with_background_downloadpolicy = simple_file("insights_commands/sudo_-iu_postgres_.usr.bin.psql_-d_foreman_-c_select_name_from_katello_root_repositories_where_download_policy_background_--csv")
