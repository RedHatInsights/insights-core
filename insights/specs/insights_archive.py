...
class InsightsArchiveSpecs(Specs):
    ...
    numastat = simple_file("insights_commands/numastat")
    numastat_memory = simple_file("insights_commands/numastat_-m")
    numactl_hw = simple_file("insights_commands/numactl_--hardware")
