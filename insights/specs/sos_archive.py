...
class SosSpecs(Specs):
    ...
    df__alP = first_file(["sos_commands/filesys/df_-alP_-x_autofs", "sos_commands/filesys/df_-alP"])
    df__li = first_file(["sos_commands/filesys/df_-li_-x_autofs", "sos_commands/filesys/df_-li"])
