...
class SosSpecs(Specs):
    ...
    hostname = first_of([simple_file("sos_commands/general/hostname_-f"), simple_file("sos_commands/general/hostname"), simple_file("sos_commands/host/hostname_-f")])
    ...
    nmcli_dev_show = first_of([simple_file("sos_commands/networking/nmcli_dev_show"), glob_file("sos_commands/networkmanager/nmcli_dev_show_*")])
