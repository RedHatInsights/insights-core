...
class SosSpecs(Specs):
    ...
    numastat = simple_file("sos_commands/numa/numastat")
    numastat_memory = simple_file("sos_commands/numa/numastat_-m")
    numactl_hw = simple_file("sos_commands/numa/numactl_--hardware")
