...
class SosSpecs(Specs):
    ...
    journal_since_boot = first_file(["sos_commands/logs/journalctl_--no-pager", "sos_commands/logs/journalctl_--no-pager_--boot", "sos_commands/logs/journalctl_--no-pager_--catalog_--boot", "sos_commands/logs/journalctl_--all_--this-boot_--no-pager"])
