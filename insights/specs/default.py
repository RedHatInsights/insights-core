...
class DefaultSpecs(Specs):
    ...
    systemctl_show_all_services_with_cpuaccounting = simple_command("systemctl show *.service --all --property=Names,CPUAccounting,CPUQuotaPerSecUSec,CPUShares,StartupCPUShares,UnitFileState,SubState")
