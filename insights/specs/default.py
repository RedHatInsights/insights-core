...
from insights.specs.datasources import (
    ...
    dir_list, ethernet, httpd, ipcs, kernel_module_list, kdump_initramfs_image, lpstat, md5chk,
...
class DefaultSpecs(Specs):
    ...
    lsinitrd_kdump_image = foreach_execute(kdump_initramfs_image.kdump_image, "/usr/bin/lsinitrd %s")
