...
class DefaultSpecs(Specs):
    ...
    hammer_settings_list = simple_command("/usr/bin/hammer --interactive 0 --output json settings list --search 'destroy_vm_on_host_delete|unregister_delete_host'", inherit_env=["HOME"])
