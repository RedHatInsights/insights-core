...
class DefaultSpecs(Specs):
    ...
    bpftool_link_list = simple_command("/usr/sbin/bpftool link list --json")
    bpftool_map_list = simple_command("/usr/sbin/bpftool map list --json")
    bpftool_net_list = simple_command("/usr/sbin/bpftool net list --json")
    bpftool_prog_list = simple_command("/usr/sbin/bpftool prog list --json")
