...
class DefaultSpecs(Specs):
    ...
    localectl = simple_command("/usr/bin/localectl")
    ...
    rsyslog_tls_ca_cert_enddate = command_with_args("/usr/bin/openssl x509 -in %s -enddate -noout", ssl_certificate.rsyslog_tls_ca_cert_file)
