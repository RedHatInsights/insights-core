...
from insights.specs.datasources import (
    ...
    ps as ps_datasource, sap, get_satellite_missed_queues)
...
class DefaultSpecs(Specs):
    ...
    satellite_missed_pulp_agent_queues = get_satellite_missed_queues.get_satellite_missed_pulp_agent_queues
