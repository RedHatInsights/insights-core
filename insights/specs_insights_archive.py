...
class InsightsArchiveSpecs(Specs):
    ...
    httpd_pid = simple_file("insights_commands/ps_aux_grep_.usr.sbin.httpd_grep_-v_grep_head_-1_awk_print_2")
    ...
    running_java = simple_file("insights_commands/ps_auxwww_grep_java_grep_-v_grep_awk_print_11_sort_-u")
    semid = simple_file("insights_commands/ipcs_-s_awk_if_NF_5_NF_._0-9_._print_NF")
