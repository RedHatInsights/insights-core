...
def test_podman_documentation():
    failed_count, tests = doctest.testmod(
        podman_list,
        globs={'images': podman_list.PodmanListImages(context_wrap(PODMAN_LIST_IMAGES)),
               'containers': podman_list.PodmanListContainers(context_wrap(PODMAN_LIST_CONTAINERS))}
    )
