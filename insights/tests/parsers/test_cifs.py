...
def test_cifs_debug_data():
    cifg_dd_obj = CIFSDebugData(context_wrap(CIFS_DEBUG_DATA_CONTENT))

    assert cifg_dd_obj.test_dfs_origin_test
    assert cifg_dd_obj.test_dfs_origin_test.get('raw_message') == "DFS origin full path: \\ad.abc.com\DFSROOT\ame1"
