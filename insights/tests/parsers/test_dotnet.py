...
from insights.parsers.dotnet import DotNetVersion, ContainerInstalledRpms
...
def test_doc_examples():
    env = {
        ...
        'con_dotnet_ver': ContainerInstalledRpms(context_wrap(dotnet_version_1))
    }
