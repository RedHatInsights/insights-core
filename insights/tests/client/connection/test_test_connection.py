...
@parametrize_exceptions(UNEXPECTED_EXCEPTIONS)
...
def test_test_urls_get_no_catch(
    get, temporary_file, post, exception, insights_connection
):
...
@mock.patch("insights.client.connection.TemporaryFile")
@mock.patch("insights.client.connection.InsightsConnection.get")
def test_test_urls_post_no_catch(
    get, temporary_file, post, exception, insights_connection
):
...
@mock.patch("insights.client.connection.InsightsConnection.post")
@mock.patch("insights.client.connection.InsightsConnection.get")
def test_legacy_urls_get_no_catch(get, post, exception, insights_connection):
...
@mock.patch("insights.client.connection.InsightsConnection.post")
@mock.patch("insights.client.connection.InsightsConnection.get")
def test_legacy_urls_post_no_catch(get, post, exception, insights_connection):
...
@mock.patch("insights.client.connection.InsightsConnection.post")
@mock.patch("insights.client.connection.TemporaryFile")
def test_test_connection_non_legacy_print_fai(
    temporary_file, post, exception, insights_connection, capsys
):
...
@mock.patch("insights.client.connection.InsightsConnection.post")
@mock.patch("insights.client.connection.logger")
def test_test_connection_legacy_error_log_no_catch(
...
@mock.patch("insights.client.connection.InsightsConnection.post")
@mock.patch("insights.client.connection.logger")
def test_test_connection_legacy_error_log_one_fail(
    logger, post, exception, insights_connection
):
...
@mock.patch("insights.client.connection.InsightsConnection.post")
@mock.patch("insights.client.connection.logger")
def test_test_connection_legacy_error_log_all_fails(
    logger, post, exception, insights_connection
):
