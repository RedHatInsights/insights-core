...
@patch('insights.client.archive.InsightsUploadConf.get_rm_conf')
...
class TestInsightsArchive(TestCase):
    ...
    def test_init_archive(self, register, mkdtemp, get_rm_conf):
        '''
        ...
        assert archive.rm_conf == get_rm_conf.return_value
        # archive initialized with rm_conf=None, call get_rm_conf
        get_rm_conf.assert_called_once()

        mkdtemp.assert_has_calls([call(prefix='/var/tmp/'),
                                  call(prefix='/var/tmp/')])
        register.assert_called_once()

    def test_init_archive_with_rm_conf(self, register, mkdtemp, get_rm_conf):
        '''
        Verify archive is created with default parameters, and
        get_rm_conf is not called if the archive is initalized with one
        '''
        config = Mock()
        archive = InsightsArchive(config, rm_conf={"test": "test"})
        ...
        assert archive.compressor == config.compressor
        assert archive.archive_name == test_archive_name
        assert archive.rm_conf == {"test": "test"}
        # archive initialized with an rm_conf, do not call
    ...
    def test_create_archive_dir_default(self, makedirs, _, __, ___):
        '''
    ...
    def test_create_archive_dir_defined_path_DNE(self, exists, makedirs, _, __, ___):
        '''
    ...
    def test_create_archive_dir_undef_path_exists(self, exists, makedirs, _, __, ___):
        '''
    ...
    @patch('insights.client.archive.os.makedirs')
    @patch('insights.client.archive.os.path.exists', return_value=True)
    def test_create_archive_dir_defined_path_exists(self, exists, makedirs, _, __, ___):
        '''
    ...
    @patch('insights.client.archive.os.makedirs')
    @patch('insights.client.archive.os.path.exists', return_value=False)
    def test_create_command_dir(self, exists, makedirs, create_archive_dir, _, __, ___):
        '''
    ...
    def test_get_full_archive_path(self, create_archive_dir, _, __, ___):
        '''
    ...
    def test_copy_dir(self, create_archive_dir, _, __, ___):
        '''
