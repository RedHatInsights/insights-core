...
def test_broker_add_exception():
    ...
    assert "insights.tests.test_add_exception.Specs.the_data" in broker.exceptions
    spec_exs = broker.exceptions["insights.tests.test_add_exception.Specs.the_data"]
