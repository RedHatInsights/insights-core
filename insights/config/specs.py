...
static_specs = {
    ...
    "docker_container_inspect"  : DockerHostCommandSpec("/usr/bin/docker inspect {docker_containers}", docker_containers=r"\S+"),
    "docker_image_inspect"      : DockerHostCommandSpec("/usr/bin/docker inspect {docker_images}", docker_images=r"\S+"),
    ...
    "fc-match"                  : CommandSpec("/bin/uname -r | grep -F '3.10' > /dev/null && /bin/fc-match -sv 'sans:regular:roman' family fontformat"),
