...
from insights.parsers.tests.test_modinfo import MODINFO_I40E, MODINFO_INTEL, MODINFO_BNX2X, MODINFO_IGB, MODINFO_IXGBE, \
...
def test_modinfo():
    ...
    modinfo_obj = comb.data['aesni-intel']
