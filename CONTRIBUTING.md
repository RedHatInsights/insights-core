...
To archive this goal and for maintaining convenience,
...
- To keep backward compatibility for Egg delivery, all core related updates
  ...
  Below is suggested backport steps:
        ...
        git rev-parse branch_of_the_existing_PR  # get the commit-id
        git fetch upstream 3.0_egg
        git checkout -b new_branch 3.0_egg
...
- If a PR is targating to core framework, data processing (Parsers or Combiners)
  ...
  to the 3.0_branch together with the PR to the master branch.
